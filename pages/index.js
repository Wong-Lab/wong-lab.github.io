...
function Hero() {
  return (
    <section className='relative text-white w-screen bg-[rgb(2,0,36)] -mx-14 -mt-[60px] h-content max-w-[1920px]'>
      <Image
      ...
      />
      <div className='relative px-14 py-28 pt-32 md:p-15 max-w-prose min-h-[40em] space-y-8 z-10'>
